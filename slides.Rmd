...
## Demo Einlesen/Importieren und Transformieren von Daten
- Download von pisa2012che als SPSS-Datei

- Download von pisa2012che als Excel-Datei 

- Einlesen von Daten aus einer SPSS-Datei mit dem `haven` Package
- Einlesen von Daten aus einer Excel-Datei mit dem `readxl` Package
